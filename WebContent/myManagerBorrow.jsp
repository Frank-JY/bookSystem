...
<%@ include file="head.jsp" %>
	...
	if(null != session.getAttribute("myBorrowMap") && session.getAttribute("identity").equals("管理员")) {
		@SuppressWarnings("unchecked")
		Map<ManagerBorrow, String> myBorrowMap = (Map<ManagerBorrow, String>)session.getAttribute("myBorrowMap");
		Set<Map.Entry<ManagerBorrow, String>> myBorrowSet = myBorrowMap.entrySet();
