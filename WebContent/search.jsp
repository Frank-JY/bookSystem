        ...
        <td> 
          ...
          <!-- 商品循环开始 -->
       	...
       	Iterator<Map.Entry<Books, String>> qs1 = null;
          	if(null != session.getAttribute("searchBooksMap")) {
          		@SuppressWarnings("unchecked")
      			Map<Books, String> booksMap = (Map<Books, String>)session.getAttribute("searchBooksMap");
      			Set<Map.Entry<Books, String>> booksSet = booksMap.entrySet();
