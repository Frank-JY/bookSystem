...
<%@ include file="head.jsp" %>
	<%
		...
		String photo = "";
		String error = "";
		Iterator<Map.Entry<Books, String>> qs1 = null;
		Iterator<BookType> qs2 = null;
		if(null != session.getAttribute("bookMap")) {
			@SuppressWarnings("unchecked")
			Map<Books, String> bookMap = (Map<Books, String>)session.getAttribute("bookMap");
			Set<Map.Entry<Books, String>> bookSet = bookMap.entrySet();
			qs1 = bookSet.iterator();
			if(qs1.hasNext()){
				Map.Entry<Books, String> set1 = qs1.next();
				Books book = set1.getKey();
				String typeName = set1.getValue();
	...
	<table align="center" style="font-size: 20px;">
		...
		<tr>
			...
			<td>
				...
				<a href="manageBookType.jsp">管理图书类型</a>
			</td>
		</tr>
		<tr>
			<td>图书库存：</td>
