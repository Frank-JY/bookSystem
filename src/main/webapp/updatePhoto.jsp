...
<%@ include file="head.jsp" %>
	...
	<br>
	<form action="UpdatePhotoServlet" enctype="multipart/form-data" method="post">
		...
		<center>
			...
			<input type="button" value="返回" onclick="window.location='ManageBookServlet?action=update&bookId=<%=bookId %>'" style="background-color:#66CCFF">	
		</center>
	</form>
