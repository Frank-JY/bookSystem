...
<%@ include file="head.jsp" %>
	...
	<form action="AddBook2Servlet" method="post" enctype="multipart/form-data">
	<table align="center" style="font-size: 20px;">
		...
		<tr>
			...
			<td>
				...
				<a href="ManageBookTypeServlet?tag1=1">管理图书类型</a>
			</td>
		</tr>
		<tr>
			<td>图书总数量：</td>
		...
		<tr>
			<td>图书封面：</td>
			<td><input type="file" name="photo" size="20" value="<%=photo %>"></td>
		</tr>
	</table>
