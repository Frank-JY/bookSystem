    ...
    <table width="900" height="60" cellpadding="0" cellspacing="0" border="0">
      <tr>
        <td> 
          ...
          <!-- 商品循环开始 -->
           <%     
       		if(null != session.getAttribute("newBookList")) {
       			@SuppressWarnings("unchecked")
       			List<Books> newBookList = (List<Books>)session.getAttribute("newBookList");     		
          		int i = 1;
          		if(null == newBookList) {
          			out.write("无相关记录！");
          		}
          ...
          <div id="search" align="center">
             <dl>
               <dt class="picture">
               No<%=i++ %>:
                 <a href="BookDetailsServleet?bookId=<%=book.getBookId() %>&tag=11"> <img src="image/upload/<%=book.getPhoto() %>" width="130" height="180" border="1"/></a>
               </dt>
               	<dt>
