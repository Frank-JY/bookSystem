...
<%@ include file="head.jsp" %>
	...
	%>
		<tr>
			...
			<td>
				<a href="PassUserActionServlet?action=pass&userName=<%=user1.getUserName() %>" onclick="return pass();">同意</a>&nbsp;&nbsp;
				<a href="PassUserActionServlet?action=reject&userName=<%=user1.getUserName() %>" onclick="return reject();">不同意</a>
			</td>
		</tr>
	...
	%>
		<tr>
			...
			<td>
				<a href="PassUserActionServlet?action=pass&userName=<%=user2.getUserName() %>" onclick="return pass();">同意</a>&nbsp;&nbsp;
				<a href="PassUserActionServlet?action=reject&userName=<%=user2.getUserName() %>" onclick="return reject();">不同意</a>
			</td>
		</tr>
