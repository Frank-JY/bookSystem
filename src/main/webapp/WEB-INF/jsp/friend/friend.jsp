...
<h1 align="center">我的好友</h1>
	...
	<div class="friend1">
		<div>
			<div class="headphoto1" align="center">
				<a href="../user/lookUser.do?userName=<%=myUserUserName %>&messageTag=6">
					<img alt="头像" src="../image/upload/<%=friend.getPhoto() %>" width="70px" height="70px;" title="头像">
					<br><%=myUserUserName %>(<%=identity %>)
				</a>
			</div>
			<div class="apply" align="center">
				<a href="friendAction.do?action=pass&friendUserName=<%=myUserUserName %>" onclick="return pass();">同意</a>&nbsp;&nbsp;&nbsp;
				<a href="friendAction.do?action=reject&friendUserName=<%=myUserUserName %>" onclick="return reject();">不同意</a>
			</div>
   		</div>
	</div>
	<%
	...
	<div class="friend2">
		<div>
			...
			<div class="apply" align="center">
				<a href="../friend/friendAction.do?action=delete&friendUserName=<%=friendUserName %>" onclick="return del();">删除好友</a>
			</div>
		</div>
	</div>
	<%
