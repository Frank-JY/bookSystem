...
<%@ include file="../head.jsp" %>
	...
	<c:forEach items="${borrowList }" var="borrow">
		<tr>
			...
			<td>${i }</td>
			<td><a href="../book/bookDetails.do?bookId=${borrow.bookId}&tag=10">${borrow.bookId}</a></td>
			<td><a href="../book/bookDetails.do?bookId=${borrow.bookId}&tag=10">${borrow.bookName}</a></td>
