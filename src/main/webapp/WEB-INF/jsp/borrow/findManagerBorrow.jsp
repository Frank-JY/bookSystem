...
<%@ include file="../head.jsp" %>
	...
	if(null != session.getAttribute("borrowList")) {
		...
		List<ManagerBorrow> borrowList = (List<ManagerBorrow>)session.getAttribute("borrowList");
	...
	%> 
		<tr>
			<td><%=i++ %></td>
			<td><a href="../book/bookDetails.do?bookId=<%=borrow.getBookId() %>&tag=10"><%=borrow.getBookId() %></a></td>
			<td><a href="../book/bookDetails.do?bookId=<%=borrow.getBookId() %>&tag=10"><%=bookName %></a></td>
