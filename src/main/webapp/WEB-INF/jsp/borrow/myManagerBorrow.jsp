...
<%@ include file="../head.jsp" %>
	...
	<c:forEach items="${myBorrowList }" var="borrow">
		<tr>
			...
			<td>${i }</td>
			<td><a href="../book/bookDetails.do?bookId=${borrow.bookId}&tag=3">${borrow.bookId}</a></td>
			<td><a href="../book/bookDetails.do?bookId=${borrow.bookId}&tag=3">${borrow.bookName}</a></td>
