...
<%@ include file="../head.jsp" %>
	...
	%> 
		<tr>
			<td><%=i++ %></td>
			<td><a href="../book/bookDetails.do?bookId=<%=borrow.getBookId() %>&tag=3"><%=borrow.getBookId() %></a></td>
			<td><a href="../book/bookDetails.do?bookId=<%=borrow.getBookId() %>&tag=3"><%=bookName %></a></td>
		...
		%>
			...
			<td><center><a href="backBook.do?id=<%=borrow.getId() %>&identity=manager" onclick="return back();">归还图书</a></center></td>
		<%
