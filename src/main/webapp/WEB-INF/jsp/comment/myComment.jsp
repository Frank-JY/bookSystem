...
<%@ include file="../head.jsp" %>
   ...
   <div class="comment">
			...
			<div class="del">
				<a href="../comment/deleteComment1.do?id=<%=comment.getId() %>" onclick="return del();">
					<img alt="删除" src="../image/upload/image/del.png" width="50" height="50" title="删除">
				</a>
			</div>
			<div class="commentphoto">
				<a href="../user/lookUser.do?userName=<%=comment.getUserName() %>&identity=<%=comment.getIdentity() %>&messageTag=5">
					<img alt="头像" src="../image/upload/<%=comment.getPhoto() %>" width="100px" height="100px;" title="头像">
				</a>
			</div>
			<div class="bookcommentphoto">
				<a href="../book/bookDetails.do?bookId=<%=book.getBookId() %>&tag=13">
   ...
   <center>
		...
		<a href="toMyComment.do?page=1">首页</a>
		<a href="toMyComment.do?page=<%=(currentPage - 1)%>">上页</a>
		<a href="toMyComment.do?page=<%=(currentPage + 1)%>">下页</a>
		<a href="toMyComment.do?page=<%=pUtil.getPageCount()%>">末页</a>
	</center>
