...
<%@ include file="../head.jsp" %>
	...
	%> 
		<tr>
			<td><a href="bookDetails.do?bookId=<%=book.getBookId() %>&tag=6"><%=book.getBookId() %></a></td>
			<td><a href="bookDetails.do?bookId=<%=book.getBookId() %>&tag=6"><%=book.getBookName() %></a></td>
			...
			<td>
				<center>
					<a href="manageBook.do?action=delete&bookId=<%=book.getBookId() %>" onclick="return del();">删除</a>&nbsp;
					<a href="manageBook.do?action=in&bookId=<%=book.getBookId() %>">上架</a>&nbsp;
					<a href="manageBook.do?action=out&bookId=<%=book.getBookId() %>">下架</a>&nbsp;
					<a href="manageBook.do?action=update&bookId=<%=book.getBookId() %>">修改</a>
				</center>
			</td>
		</tr>
