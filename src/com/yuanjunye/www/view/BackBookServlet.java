...
public class BackBookServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(identity.equals("student")) {
			...
			boolean bool1 = borrowService.back1(id, due, inTime);
			...
			boolean bool2 = bookService.updateAmount(bookId, amount, status);
			if(bool1 || bool2) {
			...
			boolean due = inTime.after(endTime);
			boolean bool1 = borrowService.back2(id, due, inTime);
